...
/**
 * Function to find the greatest product
 * @return {number} biggest product
 */
function findMaxProduct() {
  for (let i = 0; i < grid.length; ++i) {
    for (let j = 0; j < grid.length; ++j) {
     // compare vertical
     if (i <= grid.length - nbAdjacent) {
       let verticalMax = 1;
     ...
     if (j <= grid.length - nbAdjacent && i <= grid.length - nbAdjacent) {
       let diagonalMax = 1;
       for (let m = 0; m < nbAdjacent; ++m) {
     ...
     if (j >= nbAdjacent - 1 && i <= grid.length - nbAdjacent) {
       let diagonalMax = 1;
       for (let m = 0; m < nbAdjacent; ++m) {
         diagonalMax *= grid[i + m][j - m];
       }
